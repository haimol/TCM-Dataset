...
The **Extracted-Data** (11,349 questions) comes from various TCM educational sources. Please cite the original sources appropriately when using this portion of the dataset.
